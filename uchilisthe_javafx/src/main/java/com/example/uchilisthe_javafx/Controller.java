...
public class Controller {
    ...
    @FXML
    private TextField studentFamilyNameField;
    ...
    @FXML
    private TextField teacherFamilyNameField;
   ...
   // public ObservableList<> gl = FXCollections.observableArrayList();
    ...
    void addStudent(ActionEvent event) {
        DatabaseConnection.addStudent(studentNameField.getText(), studentFamilyNameField.getText());
    }

    @FXML
    void addTeacher(ActionEvent event) {
        DatabaseConnection.addTeacher(teacherNameField.getText(), teacherFamilyNameField.getText());
    }
