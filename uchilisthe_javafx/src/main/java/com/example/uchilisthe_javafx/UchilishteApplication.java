...
public class UchilishteApplication extends Application {
    ...
    public static void main(String[] args) {
        ...
        studentlist.add(new Student("gary", "smith"));
        studentlist.add(new Student("ivan", "smetrov"));
        studentlist.add(new Student("ivan2", "ivanov"));
        studentlist.add(new Student("petyr", "kirchov"));
